        ...
        await tecimobService
          ...
          .then((res) => {
            ...
            setTemplateData({
                ...
                backgroundImage: res.data.data.images[2]?.file_url?.large || res.data.data.images[1]?.file_url?.large || res.data.data.images[0]?.file_url?.large || "",
                firstImage: res.data.data.images[3]?.file_url?.large || res.data.data.images[2]?.file_url?.large || res.data.data.images[1]?.file_url?.large || "",
                secondImage: res.data.data.images[4]?.file_url?.large || res.data.data.images[3]?.file_url?.large || res.data.data.images[2]?.file_url?.large || "",
                thirdImage: res.data.data.images[5]?.file_url?.large || res.data.data.images[4]?.file_url?.large || res.data.data.images[3]?.file_url?.large || "",
